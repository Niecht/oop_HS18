...
public final class SwitchGuiSwingDemo extends JFrame implements ActionListener {
    ...
    private final JButton buttonOn = new JButton("Start");
    private final JButton buttonOff = new JButton("Stop");
    ...
    public void actionPerformed(final ActionEvent event) {
        if (event.getSource() == buttonOn) {
            ...
            running = true;
            LOG.debug("ActionEvent von ON-Button empfangen und verarbeitet.");
        }
